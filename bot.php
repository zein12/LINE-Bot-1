	...
	foreach ($events['events'] as $event) {
      ...
      //if (strpos($text, "หา") !== false) {
        ...
        if(empty($result_text)){//ถ้าไม่พบให้หาจาก en
          ...
          curl_setopt($ch1, CURLOPT_URL, 'https://id.wikipedia.org/w/api.php?format=json&action=query&prop=extracts&list=allcategories&exintro=&explaintext=&titles='.$text);
